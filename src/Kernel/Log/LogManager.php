...
namespace Aqil\SiluAi\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('AqilSiluAi', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir() . '/AqilSiluAi/AqilSiluAi.log',
